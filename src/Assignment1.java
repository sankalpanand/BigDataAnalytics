...
public class Assignment1 {
	...
	public void parseFile() throws IOException 
	{
		...
		try {
			...
			double averageBid = 0;
			double averageAsk = 0;
			double averageAskPrev2 = 0;
			double averageAskPrev1 = 0;
			...
			while ((line = br.readLine()) != null) 
			{
				...
				if(prevMinute != -1 && currMinute != prevMinute)
				{
					...
					// Calculate average ask price of the previous minute interval
					averageAskPrev1 = (double) totalAsk/count; 
					
					// Check (n-1) minute interval's value with (n-2)'s interval's average.
					// Based on that, decide direction 
					if(averageAskPrev1 > averageAskPrev2) askDirection = 1;
					else askDirection = 0;
					...
					// (n-2)'s interval's average becomes (n-1)'s interval's average which will be used next time
					averageAskPrev2 = averageAskPrev1;
